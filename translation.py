...
© @thwarikh"""
    ...
    UPGRADE_TEXT = """FMB_DL-bot Paid Plans
-------
Plan: FREE
...
/upgrade or Try 1800 seconds later."""
    ...
    FED_UP_WITH_CRAP = "This bot is no longer leeching links for free users. @FMB_DLBot is open source, and you can deploy your own telegram upload by clicking on the links, available in GitHub README. or, Better /upgrade the subscription to continue using this bot."
